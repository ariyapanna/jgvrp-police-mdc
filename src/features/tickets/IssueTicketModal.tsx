...
const IssueTicketModal = ({ open, onClose, targetName, setTargetName, reason, setReason, fine, setFine, loading, onSubmit }: IssueTicketModalProps) => {
    return (
        <Modal
            open={open}
            onClose={onClose}
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Please describe the reason for the ticket..."
                            className="
